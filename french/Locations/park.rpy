...
translate french park_1b3edabc:
    ...
    # "There's not anything to do here at the moment, so I go back to the car."
    "Il n'y a rien à faire ici pour le moment, alors je retourne à la voiture."

# game/Locations/park.rpy:53
translate french park_df3dcff2:

    # "I spot Kendra sitting over in the skate park by herself, her face a picture of depression."
    "J'aperçois Kendra assise toute seule au skatepark, le visage marqué par la déprime."

# game/Locations/park.rpy:54
translate french park_4a2ac7dc:

    # "Honestly, it's one of the saddest things I've ever seen."
    "Honnêtement, c'est l'une des choses les plus tristes que j'aie jamais vues."

# game/Locations/park.rpy:59
translate french park_e8bf8dff:

    # "I don't really feel like dealing with this right now, so I leave."
    "Je n'ai pas vraiment envie de m'occuper de ça pour l'instant, alors je m'en vais."

# game/Locations/park.rpy:63
translate french park_d8ea04b6:

    # "A group of older teenagers are riding around on skateboards."
    "Un groupe d'adolescents plus âgés font des tours en skateboard."

# game/Locations/park.rpy:66
translate french park_9adc8a89:

    # "A group of people are standing in a covered picnic area, talking loudly and listening to music coming from one of their phones."
    "Un groupe de personnes se tient dans une aire de pique-nique couverte, parlant fort et écoutant de la musique provenant d'un de leurs téléphones."

# game/Locations/park.rpy:72
translate french walkpark_b6b09adf:

    # "I take a relaxing stroll around the trail."
    "Je fais une petite balade relaxante sur le sentier."

# game/Locations/park.rpy:74
